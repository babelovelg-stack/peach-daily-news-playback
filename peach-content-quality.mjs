...
const TECHNOLOGY_NEWS_PATTERN = /科学家|科研|研究团队|实验|人工智能|AI|机器人|电子皮肤|柔性传感器|航天|卫星|火箭|芯片|集成电路|区块链|国际标准化组织|ISO|量子|6G|新材料|基因|疫苗|算法|望远镜|显微成像|光学衍射层析|LED-ODT|新能源|清洁能源|气候研究|生态监测|技术突破|科学发现|工程技术|考古发现|考古实证|科技考古|轮轴机械|新鸟种|鸟类物种名录|物种新记录|水[、和]冰|分子排列|加速器|原子核|分子模块|收获指数|育种研究|田间试验|数学家|数学研究|菲尔兹奖/i;
