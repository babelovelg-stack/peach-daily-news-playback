export const LOW_QUALITY_NEWS_SOURCE_PATTERN = /会展网|行业品牌会展|电力展会|AI热点小时报|热点速递|快讯[:：]|AI动画课堂|民生情报站|^(?:对谈|访谈|专访|观点|圆桌)[｜|:：]|(?:AI|人工智能).{0,12}(?:教学|教育).{0,20}(?:死记硬背|背知识点|如何落地|改变学习方式)|板块.*(?:大涨|涨停)|\d+余?股涨停|涨停潮|股价|股票|期货市场|开票销售收入|销售收入同比|成交额同比|完成对.+重组|重组工作|全资子公司|思政教育一体化|热播影片|同款美食|主题航班|机上餐食|扬善计划|致敬榜样|荣膺.*(?:榜样|称号)|榜样企业|护航儿童健康成长/;
...
const INTERNATIONAL_MAJOR_EVENT_PATTERN = /联合国|APEC|亚太经合组织|二十国集团|G20|世界卫生组织|世卫组织|世界贸易组织|国际原子能机构|联合国教科文组织|多国(?:政府|代表|领导人)|全球(?:气候|卫生|安全|贸易|治理)|国际(?:气候|卫生|安全|科技|经贸|贸易|人工智能|能源).{0,12}(?:会议|协议|规则|合作|治理|倡议|决定)|气候大会|国际空间站|全球公共卫生|多瑙河|跨国河流|欧洲.{0,18}(?:高温|干旱|低水位|野火|山火|森林火灾|疏散)|(?:法国|希腊|西班牙).{0,24}(?:野火|山火|森林火灾|疏散)|(?:日本|危地马拉|印度尼西亚|冰岛|意大利|菲律宾|新西兰|墨西哥|国外|海外).{0,24}(?:地震|火山|洪水|台风)|(?:乌克兰|俄罗斯|基辅).{0,24}(?:导弹|空袭|袭击|停火|谈判)/i;
const POLITICS_NEWS_PATTERN = /国务院|全国人大|全国政协|教育部|科技部|国家网信办|国家发展改革委|最高人民法院|最高人民检察院|政策|法律|法规|条例|管理办法|指导意见|国家标准|监管|治理|改革|国家规划|政府工作|外交|应急响应/;
const TECHNOLOGY_NEWS_PATTERN = /科学家|科研|研究团队|实验|人工智能|AI|机器人|电子皮肤|柔性传感器|航天|卫星|火箭|芯片|集成电路|区块链|国际标准化组织|ISO|量子|6G|新材料|基因|疫苗|算法|望远镜|显微成像|光学衍射层析|LED-ODT|新能源|清洁能源|海上风电|浮式风电|风电平台|气候研究|生态监测|技术突破|科学发现|工程技术|考古发现|考古实证|科技考古|轮轴机械|新鸟种|鸟类物种名录|物种新记录|水[、和]冰|分子排列|加速器|原子核|分子模块|收获指数|育种研究|田间试验|数学家|数学研究|菲尔兹奖/i;
