...
const LOCAL_SELF_PROMOTION_PATTERNS = [
  ...
  /(?:科技馆|博物馆|展览馆).{0,30}(?:人工智能|AI|科技).{0,20}(?:主题展|体验展).{0,18}(?:邀你|共探|启幕|开幕|开展|开始)/i,
...
const INTERNATIONAL_MAJOR_EVENT_PATTERN = /联合国|APEC|亚太经合组织|二十国集团|G20|世界卫生组织|世卫组织|世界贸易组织|国际原子能机构|联合国教科文组织|多国(?:政府|代表|领导人)|全球(?:气候|卫生|安全|贸易|治理)|国际(?:气候|卫生|安全|科技|经贸|贸易|人工智能|能源).{0,12}(?:会议|协议|规则|合作|治理|倡议|决定)|气候大会|国际空间站|全球公共卫生|多瑙河|跨国河流|欧洲.{0,18}(?:高温|干旱|低水位|野火|山火|森林火灾|疏散)|(?:法国|希腊|西班牙|韩国).{0,24}(?:高温|热射病|中暑|高温疾病|疏散)|(?:日本|危地马拉|印度尼西亚|冰岛|意大利|菲律宾|新西兰|墨西哥|哥伦比亚|国外|海外).{0,24}(?:地震|火山|洪水|台风)|(?:国际|全球|国外|海外|尼泊尔).{0,30}(?:乙脑|流行性乙型脑炎|传染病疫情|公共卫生危机)|美国.{0,24}(?:参议院|众议院|国会).{0,24}(?:临时拨款|政府预算|拨款法案)|(?:乌克兰|俄罗斯|基辅).{0,24}(?:导弹|空袭|袭击|停火|谈判)/i;
const POLITICS_NEWS_PATTERN = /国务院|全国人大|全国政协|教育部|科技部|自然资源部|国家统计局|国家网信办|国家发展改革委|最高人民法院|最高人民检察院|居民消费价格(?:指数)?|CPI|政策|法律|法规|条例|管理办法|指导意见|国家标准|监管|治理|改革|国家规划|政府工作|外交|应急响应/i;
const TECHNOLOGY_NEWS_PATTERN = /科学家|科研|研究团队|实验|人工智能|AI|机器人|智能眼镜|电子皮肤|柔性传感器|航天|卫星|火箭|芯片|集成电路|区块链|国际标准化组织|ISO|量子|6G|新材料|基因|疫苗|算法|望远镜|日全食|日食|银河系|分子云|气体盘|海洋科考|科考船|水下滑翔机|显微成像|光学衍射层析|LED-ODT|新能源|清洁能源|海上风电|浮式风电|风电平台|C919|国产大飞机|民用飞机|商业航班|气候研究|生态监测|技术突破|科学发现|工程技术|考古发现|考古实证|科技考古|轮轴机械|新物种|新鸟种|鸟类物种名录|物种新记录|16S rRNA|求偶鸣声|水[、和]冰|分子排列|加速器|原子核|分子模块|收获指数|育种研究|田间试验|数学家|数学研究|菲尔兹奖/i;
